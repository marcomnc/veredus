    ...
    public function getStoreFromCountry($country = null) {
        ...
        if ($country !== false) {
            foreach (Mage::getModel('core/store')->getCollection() as $store) {
                //Check WebSite. Aggiunto conotrollo che lo store appartenga al website corrente
                if ($store->getIsActive() && $store->getWebsiteId() == Mage::app()->getStore()->getWebsiteId()) {
